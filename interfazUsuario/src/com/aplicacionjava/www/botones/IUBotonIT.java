 ...
 * @author rudolf
 */
public class IUBotonIT extends JComponent{
     ...
     */
    public IUBotonIT(String texto, String url, Limitacion limitacion) {
        this.texto = texto;
        this.url = url;
    ...
    private void construirComponentes(){
        ...
        iuTexto = new IUEtiqueta(texto, new Limitacion(iuImagen.getLimitacion().getX() + iuImagen.getLimitacion().getAncho() + limitacion.getPorcentajeAncho(1), limitacion.getPorcentajeAlto(20), limitacion.getPorcentajeAncho(95) - limitacion.getPorcentajeAlto(90), limitacion.getPorcentajeAlto(60)));
    ...
    public void addEventoTeclado(KeyAdapter evento){
        addKeyListener(evento);
        iuImagen.addKeyListener(evento);
        iuTexto.addKeyListener(evento);
    }
