 ...
 * @author neo
 */
public class IUBotonTI extends JComponent{
    public IUEtiquetaI iuImagen;
    public IUEtiqueta iuTexto;
    
    private String url;
    private String texto;
    private int porcentajeAnchoImagen;
    private int porcentajeAltoImagen;
    ...
    /**
     * Interfaz de Usuario Boton de Texto e Imagen, que hereda del JComponent, tiene un color degradado y un borde redondeado, los cuales es posible modificar la forma y el color del boton.
     ...
     * @param porcentajeAnchoImagen determina el porcentaje de altura de la imagen. si y solo si el valor debe estar en el rango de [1 - 100]
     * @param porcentajeAltoImagen determina el porcentaje de altura del texto. si y solo si el valor debe estar en el rango de [1 - 100]
     * @param porcentajeAltoTexto
     */
    public IUBotonTI(String texto, String url, Limitacion limitacion, int porcentajeAnchoImagen, int porcentajeAltoImagen, int porcentajeAltoTexto) {
        this.texto = texto;
        this.url = url;        
        this.limitacion = limitacion;
        this.porcentajeAnchoImagen = porcentajeAnchoImagen;
        this.porcentajeAltoImagen = porcentajeAltoImagen;
    ...
    private void construirBoton(){
        ...
        construirComponentes(getLimitacion());
    }
    private void construirComponentes(Limitacion limite){
        iuImagen = new IUEtiquetaI(url, new Limitacion(limite.getPorcentajeAncho(100 - porcentajeAnchoImagen)/2, (limite.getPorcentajeAlto(100 - porcentajeAltoImagen - porcentajeAltoTexto))/3, limite.getPorcentajeAncho(porcentajeAnchoImagen), limite.getPorcentajeAlto(porcentajeAltoImagen)));
        //iuImagen.setBorder(new LineBorder(Color.RED));
        add(iuImagen);
        
        iuTexto = new IUEtiqueta(texto, new Limitacion(limite.getPorcentajeAncho(2), iuImagen.getLimitacion().getTamY(2), limite.getPorcentajeAncho(96), limite.getPorcentajeAlto(porcentajeAltoTexto)));        
